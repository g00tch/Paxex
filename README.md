![Example-Logo](https://i.imgur.com/cUfbHco.png)

# Paxex Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Paxex Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)
...
***Step 1***
* Download and install the Paxex wallet [here](https://github.com/paxex/paxchange/releases)
***
...
***Step 3***
* Send EXACLY 5000 PAXEX to a receive address within your wallet.
***

***step 4***
* After your transaction confirms, go to the debug console within the wallet 

![Example-console](https://i.imgur.com/FaQHAIw.png)
***
...
![Example-outputs](https://i.imgur.com/hjCVHIa.png)
***
...
![Example-create](https://i.imgur.com/s1a1Y1F.png)
***
...
![Example-create](https://i.imgur.com/NqZgApj.png)
...
`paxchange-cli masternode status`
